-- DDL: Database schema for Energy as a Service Platform
...
CREATE INDEX IF NOT EXISTS idx_portfolios_company ON portfolios(company_name);
CREATE INDEX IF NOT EXISTS idx_buildings_portfolio ON buildings(portfolio_id);
CREATE INDEX IF NOT EXISTS idx_buildings_type_location ON buildings(building_type, location);
CREATE INDEX IF NOT EXISTS idx_energy_usage_building_date ON energy_usage(building_id, reading_date DESC);
CREATE INDEX IF NOT EXISTS idx_energy_usage_type_date ON energy_usage(energy_type, reading_date DESC);
CREATE INDEX IF NOT EXISTS idx_energy_meters_building ON energy_meters(building_id);
CREATE INDEX IF NOT EXISTS idx_projects_building_status ON energy_projects(building_id, project_status);
CREATE INDEX IF NOT EXISTS idx_opportunities_building_priority ON project_opportunities(building_id, priority_score DESC);
CREATE INDEX IF NOT EXISTS idx_reports_portfolio_date ON sustainability_reports(portfolio_id, reporting_period_end DESC);
